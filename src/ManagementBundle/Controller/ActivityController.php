...
use ManagementBundle\Entity\Activity;
use ManagementBundle\Form\ActivityType;
...
class ActivityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $activities = $em->getRepository('ManagementBundle:Activity')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ManagementBundle\Form\ActivityType', $activity);
    ...
    {
        $deleteForm = $this->createDeleteForm($activity);
        $editForm = $this->createForm('ManagementBundle\Form\ActivityType', $activity);
